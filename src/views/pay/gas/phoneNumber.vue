  ...
  <div class="app-container">
    ...
    <div class="fkj-footer">
      <div class="fkj-footer-left">
        <v-touch v-if="this.$store.state.ownerInfo.id" tag="span" class="my-button" @tap="router('/owner/gasPayGas')">
          <i class="el-icon-arrow-left"></i>取消</v-touch>
        <v-touch v-else tag="span" class="my-button" @tap="router('/pay/gas/gas')">
