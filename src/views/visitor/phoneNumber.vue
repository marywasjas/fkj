  ...
  <div class="app-container">
    <div class="fkj-content">
      <div class="fkj-content-left">
        ...
        <div>
          <v-touch autocomplete="off" tag="input" ref="valid" id="validId" class="my-input valid-input" @tap="getFocus" data-callback="callback"
    ...
    <div class="fkj-footer">
      <div class="fkj-footer-left">
        <v-touch tag="span" class="my-button" @tap="router('/visitor/cardInfo')">上一步</v-touch>
      </div>
...
<script type="text/babel">
  ...
  export default {
    ...
    methods: {
      reInput() {
        this.$store.commit('visitorFrom', { type: 'visitorPhone' })
      ...
      focusclick() {
        ...
        testValidNum({ phone: phoneNum, code: validNum }).then(response => {
          ...
          if (response.code === 0) {
            _this.$store.commit('visitorFrom', { type: 'visitorPhone', value: phoneNum })
            _this.router('/visitor/photo')
