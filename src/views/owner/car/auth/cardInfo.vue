  ...
  <div class="app-container">
    ...
    <div class="fkj-footer">
      <div class="fkj-footer-left">
        <v-touch tag="span" class="my-button" @tap="router('/owner/carAuth/identificationCode')">
...
<script>
  ...
  export default {
    ...
    methods: {
      cleanFrom() {
        this.form = null
        this.$store.commit('carAuth', { type: 'cardInfo' })
        this.main()
      },
      main() {
        const _this = this
        getCardInfo(function(data) {
          ...
          if (data.ret === 0) {
            _this.$store.commit('carAuth', { type: 'cardInfo', value: data.Certificate })
            _this.$router.push('/owner/carAuth/phoneNumber')
