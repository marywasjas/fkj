  ...
  <div class="app-container">
    ...
    <div class="fkj-footer">
      <div class="fkj-footer-left">
        <v-touch tag="span" class="my-button" @tap="router('/owner/carAuth/cardInfo')">
...
<script type="text/babel">
  ...
  export default {
    ...
    methods: {
      reInput() {
        this.$store.commit('carAuth', { type: 'phoneNumber' })
      ...
      focusclick() {
        ...
        testValidNum({ phone: phoneNum, code: validNum }).then(response => {
          ...
          if (response.code === 0) {
            _this.$store.commit('carAuth', { type: 'phoneNumber', value: phoneNum })
            _this.$router.push('/owner/carAuth/commit')
