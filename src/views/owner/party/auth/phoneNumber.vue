  ...
  <div class="app-container">
    ...
    <div class="fkj-footer">
      <div class="fkj-footer-left">
        <v-touch tag="span" class="my-button" @tap="router('/owner/partyAuth/cardInfo')">
...
<script type="text/babel">
  ...
  export default {
    ...
    methods: {
      reInput() {
        this.$store.commit('partyAuth', { type: 'phone' })
      ...
      focusclick() {
        ...
        testValidNum({ phone: phoneNum, code: validNum }).then(response => {
          ...
          if (response.code === 0) {
            _this.$store.commit('partyAuth', { type: 'phone', value: phoneNum })
            _this.router('/owner/partyAuth/photo')
